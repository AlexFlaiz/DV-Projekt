...
public class Fenster {
		...
		AdminBox=false;
			...
			public void run() {
				try {
					...
					String Nachricht="//GETADMIN//\n";		//Fr�gt Admin Status beim Server nach
	...
	private void initialize() {
		...
		btnSchliessen.addActionListener(new ActionListener() {
			...
			{
				Liste.setVisible(false);				//schlie�t Fenster Liste
			}
		});
		...
		btnAbbrechen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				NeuerEintrag.setVisible(false);				//schlie�t fenster NeuerEintrag
			}
		});
		...
		JButton btnEintragHinzufuegen = new JButton("Eintrag hinzuf\u00FCgen");	//Befehl zum Eintrag hinzuf�gen
		...
		JButton btnLeeren = new JButton("Leeren");				//Leere Eintr�ge in Fenster Neuer Eintrag
		...
		JCheckBox CBAdminTodo = new JCheckBox("Von Benutzer \u00E4nderbar");  //CheckBox f�r Admin
		...
		JButton btnLoeschen = new JButton("L\u00F6schen");				//Eintrag wird gel�scht
		...
		btnLoeschen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				{
				int response = JOptionPane.showConfirmDialog(btnLoeschen, "Soll der Eintrag wirklich gel�scht werden?  " + "","Eintrag l�schen",
		...
		JButton btnerledigt = new JButton("Erledigt");					//Stratus wird ge�ndert
		...
		btnNeuerEintrag.addActionListener(new ActionListener() {		//Fenster neuer Eintrag wird ge�ffnet
			public void actionPerformed(ActionEvent e) 
			{
		...
		JMenuItem mntmNeuerEintrag = new JMenuItem("Neuer Eintrag");	//Fenster neuer Eintrag wird ge�ffnet (in Men�leiste)
	...
	public static void loescheTodo(java.net.Socket socket,int i)	//ToDos werden durch den gesendeten Befehl im Server gel�scht
	{
	...
	public void fuelleListe()					//Liste in GUI neu bef�llen
	{
	...
	public void aendereStatus()	//Erledigungsstatus der ToDos werden ge�ndert
	{
		int i=index;
		int j= (index+1);
	...
	protected void SpeichernAlle()						//Speichere alle ToDos in Liste
	{
		...
		protected void Laden()				//�ffnet gespeicherte Dateien
		{
			final JFileChooser fc = new JFileChooser();
