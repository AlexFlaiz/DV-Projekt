	...
	private void initialize() {
		...
		btnEintragHinzufuegen.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					 JOptionPane.showMessageDialog(NeuerEintrag , "Maximal 150 Zeichen m�glich" , "Fehler",
		...
		list.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e)
			{
				...
				{
					Aktualisieren();
					JOptionPane.showMessageDialog(frmTodoListe , "Liste wurde Aktualisiert, bitte Eintrag erneut ausw�hlen" , "Warnung",
		...
		btnLoeschen.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
 				...
 				{
                	 JOptionPane.showMessageDialog(frmTodoListe , "Eintrag ist nicht zum l�schen freigegeben." , "Fehler",
 							JOptionPane.ERROR_MESSAGE );
 				}
				else
				{
